    ...
    <div class="site-container">
     ...
     <?php include 'header.php'; ?>
      ...
      <div class="google-map d-toppagefixed">
        ...
        <div class="col-md-6" >
          <img src="images/offices/tramitador_bogota.jpeg" width="100%" height="400" frameborder="0"
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="contact-info">
                ...
                <ul>
                  <li><i class="icon-map-marker"></i>Cra 101 No. 147 - 21 C.C Fiesta Suba Local 15 - Contiguo al SIM de SUBA</li>
                  <li>
			  <ul>
