    ...
    <!-- End Header -->
      ...
      <section class="why-choose-us grey">
        <div class="container">
          <div class="row">
            <div class="section-title align-center col-md-12">
              <h2 class="stripe">Why traders choose us</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="icon-box-container">
                <div class="icon-box">
                  <div class="the-icon">
										<a href="#"><i class="icomoon-icon-settings"></i></a>
									</div>
                  <h4>Human Capital</h4>
            ...
            <div class="col-md-4">
              <div class="icon-box-container">
                <div class="icon-box">
                  <div class="the-icon">
										<a href="#"><i class="icomoon-icon-trophy"></i></a>
									</div>
            ...
            <div class="col-md-4">
              <div class="icon-box-container">
                <div class="icon-box">
                  <div class="the-icon">
										<a href="#"><i class="icomoon-icon-briefcase"></i></a>
									</div>
                  <h4>Raw Spreads</h4>
                  <p>Receive premium pricing from Top Tier financial institutions. Pricing from Top Tier financial institutions.</p>
                  <a href="#" class="">Learn More</a>
      ...
      <section class="recent-projects">
        <div class="container">
          <div class="row">
            <div class="section-title align-center col-md-12">
              <h2 class="stripe">recent projects</h2>
            </div>
          </div>
          <div class="row">
            <ul class="isotope-filters">
              ...
              <li><a href="#" data-filter=".Financial">Financial Services</a></li>
              <li><a href="#" data-filter=".Strategic-Planning">Strategic Planning</a></li>
              <li><a href="#" data-filter=".Assurance">Assurance</a></li>
              <li><a href="#" data-filter=".Consulting">Consulting</a></li>
              <li><a href="#" data-filter=".Trades-Stocks">Trades & Stocks</a></li>
            </ul>
          </div>
          <div class="projects-list isotope">
            <div class="portfolio-item Financial">
              <img src="images/projects/1.jpg" alt="">
              <div class="overlay">
                <div class="overlay-content">
                  <a href="project_financial_services.html">
            ...
            <div class="portfolio-item Consulting">
              ...
              <div class="overlay">
                <div class="overlay-content">
                  <a href="project_strategic_planning.html">
                    <h4>Leading products</h4>
                  </a>
                  <span>Financial Services</span>
                </div>
            ...
            <div class="portfolio-item Strategic-Planning Assurance">
            ...
            <div class="portfolio-item Financial Strategic-Planning">
              <img src="images/projects/4.jpg" alt="">
              <div class="overlay">
                <div class="overlay-content">
                  <a href="project_strategic_planning.html">
                    <h4>retailer trading</h4>
                  </a>
                  <span>Financial Services</span>
                </div>
              </div>
            </div>
            <div class="portfolio-item Strategic-Planning Trades-Stocks">
            ...
            <div class="portfolio-item Financial Assurance">
            ...
            <div class="portfolio-item Trades-Stocks">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="fact-icon">
                     ...
                     <h2 class="timer" data-from="21375" data-to="25876" data-speed="5000" data-refresh-interval="50">12</h2>
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="fact-icon">
                     ...
                     <h2 class="timer"  data-from="1" data-to="12" data-speed="5000" data-refresh-interval="50">40</h2><!--End Number-->
      ...
      <!--========================news section==========================
       <section class="news-section grey">
        <div class="container">
          <div class="row">
            <div class="section-title align-center col-md-12">
              <h2 class="stripe">from the blog</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="news-box">
                ...
                <div class="news-content">
                  <a href="single-post.html"><h4>Pellentesque sapien velit</h4></a>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="team-box">
                ...
                <div class="team-info">
                  <h4>John Smith</h4>
                  <p><em>Company Menager</em></p>
                  <p>dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et consectetur dolore magna aliqua dolore.</p>
